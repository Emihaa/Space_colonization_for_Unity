...
public class AttractionPointGenerator
{
    ...
    public int PickArea(List<float> triangleAreas, float totalArea)
    {
        int triIndex = 0;
        float cumulative = 0f;
    ...
    public void PlacePoint(List<float> triangleAreas, ref float totalArea, Vector3[] normals, Vector3[] vertices, int[] triangles)
    {
    ...
    // 
    public void WeightAreas(List<float> triangleAreas, ref float totalArea, Vector3[] normals, Vector3[] vertices, int[] triangles)
    {
